...
## [2.20] — Место в рейтинге

### Улучшения
- В **рейтинге книг** на странице статистики у каждой карточки на фоне отображается **порядковый номер** — место в рейтинге крупным полупрозрачным числом, чтобы быстрее ориентироваться в списке.

---

## [2.19] — Книги автора и удобный ввод текста

### Новое
- На экране **редактирования автора** появился список **всех книг этого автора** — с иконкой статуса, прогрессом для текущих книг и датой добавления.
- **Поиск по названию** в списке книг автора — фильтр срабатывает по мере ввода.
- Нажатие на книгу в списке открывает её **карточку**.
- Если у автора ещё нет книг, показывается понятное сообщение.

### Улучшения
- При вводе **названия книги** и **заметок** клавиатура автоматически делает заглавной первую букву предложения.
- На **главной** названия книг в карточках читаются лучше — цвет текста приведён к основному.
- Список книг автора **обновляется** при каждом возврате на экран.
